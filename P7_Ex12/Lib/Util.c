...
int compareIntegers(int i1, int i2){ return comparaInteiros(i1, i2); }
string createString(string s){ return criaString(s); }
string createStringN(int n){ return criaStringN(n); }
string recriateString(string s){ return recriaString(s); }
// void destroiString(string s){ return destroiString(s); }
